...
class MainActivity : AppCompatActivity() {
    ...
    private fun initMenu() {
        addMenuProvider(object : MenuProvider {
            override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) = menuInflater.inflate(R.menu.player_menu, menu)
            override fun onMenuItemSelected(menuItem: MenuItem) = menuItem.itemId == R.id.action_settings && run {
